...
describe('Teste de porcentagem', () => {
    it('Deve calcular a porcentagem 10% de 5000 resultando em 500', () => {
    ...
    it('Deve calcular a porcentagem 5% de 1500.25 resultando em 75.0125', () => {
...
describe('Teste de Raiz', () => {
    it('Deve calcular raiz de 9 resultando em 3', () => {
        let resultado = Calculadora.raiz(9)
        expect(resultado).to.be.eq(3)
    })
    it('Deve calcular raiz de -9 resultando em NaN', () => {
        let resultado = Calculadora.raiz(-9)
        expect(resultado).to.be.NaN
    })
    it('Deve calcular raiz de 1.44 resultando em 1.2', () => {
...
describe('Teste de Potencia', () => {
    it('Deve calcular 7 elevado a 2 resultando em 49', () => {
        let resultado = Calculadora.potencia(7, 2)
        expect(resultado).to.be.eq(49)
    })
    it('Deve calcular -7 elevado a 2 resultando em 49', () => { // base negativa elevada a expoente par
        let resultado = Calculadora.potencia(-7, 2)                // resultado é positivo
        expect(resultado).to.be.eq(49)
    })
    it('Deve calcular -2 elevado a 3 resultando em -8', () => {      // base negativa elevada a expoente impar 
        let resultado = Calculadora.potencia(-2, 3)                 // resultado é negativo 
        expect(resultado).to.be.eq(-8)
    })
    it('Deve calcular 5 elevado a -2 resultando em 0.04', () => {
...
describe('Teste de Conversão de Temperatura', () => {
    it('Deve transformar 45 graus Fahrenheit em Celsius resultando 7 Celsius', () => {
